...
pretrainedF = './experiments/miniImageNet_ResNet10CosineClassifier/feat_model_net_epoch*.best'
...
pretrainedC = './experiments/miniImageNet_ResNet10CosineClassifier/classifier_net_epoch*.best'
